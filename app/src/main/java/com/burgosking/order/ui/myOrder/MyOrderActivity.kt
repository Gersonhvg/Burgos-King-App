...
class MyOrderActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnMakeOrder.setOnClickListener {
            ...
            val newOrder = OrderData(nextOrderId, session, currentDateString, newOrderCart)
    ...
    fun removeFromCart(item: MenuData) {
        mycart.remove(item)
        updateTotal()
    }
    ...
    fun deepCopyMenuList(original: MutableList<MenuData>): MutableList<MenuData> {
